...
const { add, edit, deletePost, likePost, postComment, viewPost, unlikePost, deleteComment, savePost, feed,  archivePost, sharePost, sharePostUsersListAndSearch} = require("../controller/PostController");
...
router.get("/share-user", protect, sharePostUsersListAndSearch);
